...
def SteamMini_page():
    ...
    uitleg_lable = ctk.CTkLabel(Uitleg_frame, text="De SteamMini is een klein apparaatje dat je kan verbinden met je Steam account. \nZo kan je je vrienden zien, je games en meer! Op de Mini Steam device ga naar Kolom 3 Rij 3, Connect. Wacht tot het schermpje MQTT Data Check laat zien en stuur dan de nieuwe steam ID met de login button.", text_color="white", font=("Arial", 20), wraplength=800)
